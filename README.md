...
This project could be less heavy by reimplementing HAL library with less genericity. Also size won't be a problem to implement BLE and add new features
